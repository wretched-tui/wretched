...
function GpmClient(options) {
    ...
    var path;
    try {
        path = node_fs_1.default.readlinkSync('/proc/' + pid + '/fd/0');
    }
    catch (e) { }
    ...
    var self = this;
    if (tty) {
        node_fs_1.default.stat(GPM_SOCKET, function (err, stat) {
            ...
            var gpm = node_net_1.default.createConnection(GPM_SOCKET);
            this.gpm = gpm;
...
GpmClient.prototype.__proto__ = node_events_1.EventEmitter.prototype;
...
//# sourceMappingURL=gpmclient.js.map