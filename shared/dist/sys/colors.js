...
exports.reduce = exports.hexToRGB = exports.HSBtoRGB = exports.RGBtoHSB = exports.RGBtoHex = exports.match = exports.indexToHex = exports.indexToRGB = exports.toHex = exports.nameToIndex = void 0;
var colorNames = {
    // special
    default: -1,
    // normal
...
const nameToIndex = name => exports.nameToIndex[name] ?? -1;
...
const [indexToRGB_table, indexToHex_table] = (function () {
    ...
    function set(i, r, g, b) {
        rgb[i] = [r, g, b];
        hex[i] = '#' + (0, exports.toHex)(r) + (0, exports.toHex)(g) + (0, exports.toHex)(b);
    }
    // 0 - 15
...
const indexToRGB = index => indexToRGB_table[~~index % 255];
exports.indexToRGB = indexToRGB;
const indexToHex = index => indexToHex_table[~~index % 255];
exports.indexToHex = indexToHex;
const _cache = {};
const match = function (r1, g1, b1, lookup) {
    if (typeof r1 === 'string') {
        ...
        ;
        [r1, g1, b1] = (0, exports.hexToRGB)(r1);
    }
    ...
    var ldiff = Infinity, li = lookup[0][0];
...
const RGBtoHex = function (r, g, b) {
    ...
    return '#' + (0, exports.toHex)(r) + (0, exports.toHex)(g) + (0, exports.toHex)(b);
};
...
const fourBitColors = (function () {
    ...
    return indexToHex_table.map(color => (0, exports.match)(color, undefined, undefined, lookupCopy));
})();
const threeBitColors = (function () {
    const lookupCopy = indexToRGB_table.slice(0, 8);
    return indexToHex_table.map(color => (0, exports.match)(color, undefined, undefined, lookupCopy));
})();
const reduce = function (color, total) {
    if (total <= 16) {
